...
public class MainActivity extends AppCompatActivity implements View.OnClickListener,
    ...
    private RadioGroup rgb_crop, rgb_photo_mode;
    private int aspect_ratio_x, aspect_ratio_y;
    private CheckBox cb_choose_mode, cb_isCamera, cb_isGif,
        ...
        public void onAddPicClick() {
            ...
            if (mode) {
                ...
                PictureSelector.create(MainActivity.this)
                        ...
                        //.videoMaxSecond(15)//查询视频的最大秒
                        //.videoMinSecond(10)//查询视频的最小秒
                        //.videoQuality()// 视频录制质量
                        //.recordVideoSecond()//录制视频秒数 默认10s
                ...
                PictureSelector.create(MainActivity.this)
                        ...
                        .maxSelectNum(maxSelectNum)// 最大图片选择数量
                        .minSelectNum(1)// 最小选择数量
                        .setOutputCameraPath("/JCamera")// 自定义拍照保存路径
                        .selectionMode(cb_choose_mode.isChecked() ?
                                PictureConfig.MULTIPLE : PictureConfig.SINGLE)// 多选 or 单选
                        .enablePreview(cb_preview_img.isChecked())// 是否可预览图片
                        .enableCrop(cb_crop.isChecked())// 是否裁剪
                        ...
                        .videoQuality(JCameraView.MEDIA_QUALITY_HIGH)// 视频录制质量
